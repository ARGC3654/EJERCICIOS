        ...
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="#">
                ...
                <div>
                    ...
                    <small class="text-white-50">SISTEMA DE DOCENTES </small>
                </div>
            </a>
            <div class="d-flex">
                ...
                <a href="agregar_docente.php" class="btn btn-primary-custom btn-sm">
        ...
        <div class="container">
            <div class="card card-custom mb-4">
                <div class="card-header card-header-custom d-flex justify-content-between align-items-center">
                    <h2 class="h5 mb-0"><i class="bi bi-people-fill me-2"></i>REGISTROS Docentes</h2>
                    <div class="d-flex">
